...
public class AnuncioController {
    ...
    @PostMapping
    public ResponseEntity<String> cadastrar(@RequestBody(required = false) final AnuncioDTO anuncioDTO) {
    ...
    public ResponseEntity<List<AnuncioRegistrosDTO>> obterMeusAnuncios(Authentication authenticatioToken) {
        return new ResponseEntity<>(anuncioService.listarMeusAnuncios(), HttpStatus.OK);
    }
